...
import profilImage from "../assets/IMG_0707.jpeg";
...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  const navItems = [
    ...
    { id: "education", label: "Formations", icon: "academic" },
    { id: "contact", label: "Contact", icon: "mail" },
  ];

  return (
    <>
      {/* Profile Section - Toujours visible sur mobile */}
      <div className="sidebar-profile-mobile">
        ...
        <div className="profile-info-mobile">
          ...
          <div className="social-links">
            ...
            <a
              href="https://www.linkedin.com/in/jovene-kevin-developpeur-web/"
              className="social-icon"
              aria-label="LinkedIn"
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      {/* Menu déroulant avec Navigation et Contact */}
      <div className={`sidebar-container ${isMenuOpen ? "sidebar-open" : ""}`}>
        {/* Profile Section */}
        ...
        <div className="sidebar-footer">
          <div className="contact-info">
            <div className="contact-item">
              ...
              <span>jovene.kevin@gmail.com</span>
            </div>
            <div className="contact-item">
              <svg
                className="w-4 h-4 mr-2"
